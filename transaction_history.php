    ...
    <div class="container mt-5">
      ...
      ?>
                <tr>
                    ...
                    <td><a href="invoice_print.php?order_id=<?= $order_id ?>" class="btn btn-sm btn-info">View
                            Invoice</a></td>
                </tr>
                <?php endwhile; ?>
            </tbody>
        ...
        <div class="mt-4">
            <h5>Total Revenue: <span class="text-success">Rp <?= number_format($total_revenue, 0, ',', '.') ?></span>
            </h5>
        </div>
